	...
	var _this = {
		...
		approve: function() {
			...
			if (approveForm.approveStatus) {
				...
				IQB.post(urls['rootUrl'] + '/workFlow/addzhiyaAssessPrice', {orderId: window.procBizId, assessPrice: $('#assessPrice').val(), gpsPrice: $('#gpsPrice').val(), orderAmt: $('#total').val()}, function(){
