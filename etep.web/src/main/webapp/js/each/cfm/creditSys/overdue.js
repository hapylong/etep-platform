...
IQB.overdue = function(){
	...
	var _this = {
		...
		turnTo : function(data){
			...
			var orderId=row.orderId,amount=row.curRepayAmt;
		...
		refresh : function(page){
			...
			_this.cache.t = setInterval(function(){
				$("#datagrid").datagrid2({url: urls['cfm'] + '/credit/repayment/All',queryParams : $.extend({}, $("#searchForm").serializeObject(), {pageNum: page}),
