...
public class PwdEncoder {
	...
	private static PwdEncoder encoder = new PwdEncoder();
	
	private PwdEncoder() {
    }
    
    public static void main(String[] args) {
        PwdEncoder desObj = new PwdEncoder();
        String key1 = "1";
        String key2 = "2";
        String key3 = "3";
        String data = "admin";
    ...
    public static String decode(String data){
    	return encoder.strDec(data, "1", "2", "3");
    }
     ...
     */
    private String strEnc(String data, String firstKey, String secondKey,
            String thirdKey) {
     ...
     */
    private String strDec(String data, String firstKey, String secondKey,
            String thirdKey) {
        int leng = data.length();
        String decStr = "";
        List firstKeyBt = null, secondKeyBt = null, thirdKeyBt = null;
