...
@Service
public class WfProcTaskCallBackNewService implements IWfProcTaskNewCallBackService {
	@Autowired
	...
	public void before(String dealType, Map<String, Object> procTaskData,
        ...
        try {
    		...
    		if (procBizData != null) {
                ...
                bean1.setProcMemo("测试流程验证:" + (String)procBizData.get(PROC_INSTANCEID));
                bean2.setProcInstId("db33e41f-3b76-11e7-9b54-80a589ac6c46");
                bean2.setProcMemo("测试流程验证:" + (String)procBizData.get(PROC_INSTANCEID));
